...
const int  Nthreads = 1024, maxFR = 100000, NrankMax = 6, nmaxiter = 500, NchanMax = 32, nt0max = 107;
...
__global__ void	computePCfeatures(const double *Params, const int *counter,
  ...
  volatile __shared__ float  sPCA[nt0max * NrankMax], sW[nt0max * NrankMax], sU[NchanMax * NrankMax];
