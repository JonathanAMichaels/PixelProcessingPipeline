...
tic;
ops.nt0 	  = getOr(ops, {'nt0'}, 81); % number of time samples for the templates (has to be <=81 due to GPU shared memory)
ops.nt0min  = getOr(ops, 'nt0min', ceil(20 * ops.nt0/81)); % time sample where the negative peak should be aligned
